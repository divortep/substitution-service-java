...
class CustomSubstitutionPTest extends Specification {

    def "test getType"() {
        when:
        def type = new CustomSubstitutionP().getType()
    ...
    def "test complyWith"() {
        ...
        when:
        def res = new CustomSubstitutionP().complyWith(input)
    ...
    def "test apply"() {
        ...
        when:
        def res = new CustomSubstitutionP().apply(input)
